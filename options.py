...
api = Tradier("szoum25cAYlwJUwPP4dOKIqGRGR7")
#api.options("SPY").initialize_repository()

#print(api.options("SPY").call(date(2018, 11, 2), 270))
#print(api.historical_data("SPY"))#.call(date(2018, 9, 21), 175))
#print(api.load_data("SPY")
print(api.options)
